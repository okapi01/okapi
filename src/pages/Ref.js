...
const Ref = () => {
  ...
  const copyToClipboard = () => {
    ...
    const reflink = `https://t.me/okapitapping_bot?start=r${id}\n\KAPI tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! KAPI Power Tap! 🚀`;
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Mine KAPI tokens now!",
      // eslint-disable-next-line
      url: `https://t.me/okapitapping_bot?start=r${id}\n\ `, // Replace with your link
      text: "KAPI tokens mining is live! Two is better than one!  Join my squad, and let's double the fun (and earnings 🤑)! KAPITAP Power Tap! 🚀",
    };
  ...
  const fallbackShare = (shareData) => {
    const encodedText = encodeURIComponent(
      // eslint-disable-next-line
      `${shareData.url} \n\KAPI tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! KAPITAP Power Tap! 🚀`
    );
          ...
          <div className="w-full pt-3 justify-center flex-col space-y-3 px-5">
            <div className="w-full">
              ...
              <p className="text-[13px] text-[#d0d0d0] w-full pr-4 pb-1">
                More friends, more rewards! more milestones to unlock!
              </p>
            </div>
            ...
            <div className="w-full flex items-center justify-between space-x-3 pb-3">
              ...
              <div className="w-[48.5%] flex flex-col text-[#000] font-medium text-[14px] bg-cards h-[85px] rounded-[10px] px-4 py-2 justify-start text-left relative">
                <h2 className="!m-0 font-semibold text-[#fff]">
                  ...
                  <span className="text-[18px]"> KAPI</span>
                </h2>
              ...
              <div className="w-full flex flex-col space-y-3">
                {loading ? (
                  ...
                  <p className="text-[#d0d0d0] text-center w-full now pt-8 px-5 text-[14px] leading-[24px]">
                    You have no friends 👨‍👦‍👦 Refer your frens and family, get 10% of
