      ...
      <div className="w-full flex bg-[#202020] rounded-tl-[40px] rounded-tr-[40px] mt-[2px] h-[85vh] justify-start relative flex-col items-center space-y-3 p-4 pb-24">
              ...
              <button
                ...
                <div className="w-full flex justify-center flex-col items-center">
                  ...
                  Hello Okapies, Tap Tap Tap = Reward Reward Reward, join our telegram channel for having our update on time

                  <a href="https://t.me/okapicommunity" className="text-[#ffba4c]">telegram</a>
                  </p>
